    ...
    if not sub_pos1==sub_pos2:
        ...
        #either adj is not linear
            ...
            if 0 in sub_list1 or 0 in sub_list2:
                ...
                for i in linear_sublist[:linear_adj+1]:
                  evolved_sublist.append(i)
                
                #appeding things present in the right of sub_list2 within same chromosome
                for i in circular_sublist[circular_adj+1:]:
                    evolved_sublist.append(i)
      ...
      if not sub_pos1==sub_pos2:
            ...
            #either adj is not linear
                ...
                if 0 in sub_list1 or 0 in sub_list2:
                    ...
                    for i in reversed(circular_sublist[:circular_adj+1]):
                          evolved_sublist.append(-i)
...
def perform_deletion(lst, all_gene, sub_pos, adj, length):
  #creatign a new sublist
    ...
    #linear
    #append everything before including adj
    if 0 in sub_list:
        final_length=min(length, len(sub_list)-adj-2)  
        for i in sub_list[:adj+1]:
            evolved_sublist.append(i)
        #append everything after the deleted genes    
        for i in sub_list[adj + final_length+1:len(sub_list)+1]:
            evolved_sublist.append(i)
    #circular, append everything before and not including adj
    else:
        final_length=min(length, len(sub_list)-adj)
        for i in sub_list[:adj]:
            evolved_sublist.append(i)
        for i in sub_list[adj+ final_length:]:
            evolved_sublist.append(i)
...
#picking 2 adj for DCJ and 1 dcj for insertion and deletion
def pick_adj(list, weights_sublist,operation):
  #pick a sublist
  sub_list1=[]
  
  if operation=="Deletion" or operation=="Insertion": # Deletion shouldn't happen in [] and [0,0]
    while len(sub_list1)==0 or (0 in sub_list1 and len(sub_list1)==2):
  ...
  if 0 in sub_list1:
    if operation=="Deletion":
      adj1=random.randint(0,len(sub_list1)-3) # don't take the last adj
    else:
  ...
  if operation=="DCJ":
     ...
     while(sub_pos1==sub_pos2 and adj1==adj2):
      sub_list2=random.choices(list, weights=weights_sublist, k=1)[0]
      if 0 in sub_list2:
        adj2=random.randint(0,len(sub_list2)-2)
      else:
  ...
  return adj1, adj2, sub_pos1, sub_pos2
...
def distance(evolved_list, i):
    ...
    distance_str = output_lines[1].split()[-1].strip()
       ...
       for q in range(int(avg)):
                ...
                for p in range(0,int(num_steps)):
                      ...
                      if operation=='DCJ':
                               ...
                               adj1, adj2, sub_pos1, sub_pos2=pick_adj(list, weights_sublist, operation)
                               ...
                               evolved_list=perform_deletion(list, all_gene, sub_pos1, adj1,chosen_length)
                      ...
                      if p==0:
                         ...
                         mode="a"
                      print([adj1, adj2, sub_pos1, sub_pos2])   
                      print("Evolved_list:  ")
                      print(evolved_list)
